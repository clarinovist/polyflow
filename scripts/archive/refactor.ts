...
async function main() {
    ...
    const moves = [
        {
            from: 'src/components/ui/accounting-input.tsx',
            to: 'src/components/finance/accounting/',
        },
        {
            from: 'src/components/ui/product-combobox.tsx',
            to: 'src/components/products/',
        },
        {
        ...
        {
            from: 'src/components/ui/transaction-date-filter.tsx',
            to: 'src/components/common/',
        },
        {
            from: 'src/components/ui/url-transaction-date-filter.tsx',
            to: 'src/components/common/',
        },
    ];
