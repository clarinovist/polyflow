...
async function main() {
    ...
    console.log(
        `  12500 ${before12500.name}: Rp ${before12500.balance.toLocaleString()}`,
    );
    console.log(
        `  12310 ${before12310.name}: Rp ${before12310.balance.toLocaleString()}`,
    );
    console.log(
        `  12400 ${before12400.name}: Rp ${before12400.balance.toLocaleString()}\n`,
    );
    ...
    const reclassifications = [
        {
            from: '12500',
            to: '11330',
            balance: before12500.balance,
            label: 'Reclassify FG: 12500 → 11330',
        },
        {
            from: '12310',
            to: '11310',
            balance: before12310.balance,
            label: 'Reclassify RM: 12310 → 11310',
        },
        {
            from: '12400',
            to: '11320',
            balance: before12400.balance,
            label: 'Reclassify WIP: 12400 → 11320',
        },
    ];
    ...
    for (const item of reclassifications) {
        ...
        console.log(
            `  ✅ ${item.label}: Rp ${item.balance.toLocaleString()} dipindahkan`,
        );
    }
    ...
    for (const code of toDeactivate) {
        ...
        if (Math.abs(bal.balance) > 0.01) {
            console.log(
                `  SKIP: ${code} still has non-zero balance: Rp ${bal.balance.toLocaleString()}`,
            );
            continue;
        }
    ...
    for (const code of ['11310', '11320', '11330', '12310', '12400', '12500']) {
        try {
            ...
            console.log(
                `  ${code} ${b.name}: Rp ${b.balance.toLocaleString()}`,
            );
        } catch {
