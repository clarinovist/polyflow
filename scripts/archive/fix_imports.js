...
const replacements = {
    ...
    '"@/services/invoice-service"': '"@/services/finance/invoice-service"',
    "'@/services/abc-analysis-service'":
        "'@/services/inventory/abc-analysis-service'",
    '"@/services/abc-analysis-service"':
        '"@/services/inventory/abc-analysis-service"',
    ...
    '"@/services/inventory-service"':
        '"@/services/inventory/inventory-service"',
    "'@/services/stock-aging-service'":
        "'@/services/inventory/stock-aging-service'",
    '"@/services/stock-aging-service"':
        '"@/services/inventory/stock-aging-service"',
    "'@/services/mrp-service'": "'@/services/production/mrp-service'",
    '"@/services/mrp-service"': '"@/services/production/mrp-service"',
    "'@/services/production-service'":
        "'@/services/production/production-service'",
    '"@/services/production-service"':
        '"@/services/production/production-service"',
    ...
    "'@/services/notification-service'":
        "'@/services/core/notification-service'",
    '"@/services/notification-service"':
        '"@/services/core/notification-service"',
    ...
    '"@/actions/finance-dashboard"': '"@/actions/dashboard/finance-dashboard"',
    "'@/actions/planning-dashboard'":
        "'@/actions/dashboard/planning-dashboard'",
    '"@/actions/planning-dashboard"':
        '"@/actions/dashboard/planning-dashboard"',
    "'@/actions/production-dashboard'":
        "'@/actions/dashboard/production-dashboard'",
    '"@/actions/production-dashboard"':
        '"@/actions/dashboard/production-dashboard"',
    "'@/actions/sales-dashboard'": "'@/actions/dashboard/sales-dashboard'",
    '"@/actions/sales-dashboard"': '"@/actions/dashboard/sales-dashboard"',
    "'@/actions/warehouse-dashboard'":
        "'@/actions/dashboard/warehouse-dashboard'",
    '"@/actions/warehouse-dashboard"':
        '"@/actions/dashboard/warehouse-dashboard"',
    ...
    '"@/actions/purchasing"': '"@/actions/purchasing/purchasing"',
    "'@/actions/purchasing-analytics'":
        "'@/actions/purchasing/purchasing-analytics'",
    '"@/actions/purchasing-analytics"':
        '"@/actions/purchasing/purchasing-analytics"',
