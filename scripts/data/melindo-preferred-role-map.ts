...
export const MELINDO_PREFERRED_MAP: PreferredMapping[] = [
    ...
    },
    {
        role: 'packaging',
        code: '1-131',
        name: 'Persediaan Bahan Kemasan Rafia',
        severity: 'high',
    },
    {
        role: 'cogs',
    ...
    {
        role: 'interest-income',
        code: '7-100',
        name: 'Pendapatan Bunga Bank',
        severity: 'high',
    },
    {
        role: 'adjustment-gain',
        code: '7-101',
        name: 'Pendapatan Lain-lain Diluar Usaha',
        severity: 'high',
    },
    {
        role: 'adjustment-loss',
        code: '8-202',
        name: 'Biaya Lain-lain Diluar Usaha',
        severity: 'high',
    },
    {
    ...
    },
    {
        ...
        code: '1-134',
        name: 'Persediaan Alat Tulis',
        severity: 'medium',
    },
    {
        role: 'finished-goods',
        code: '1-128',
        name: 'Persediaan Barang Jadi Rafia',
        severity: 'medium',
    },
    {
        role: 'wip',
