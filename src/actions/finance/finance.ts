...
export async function getReceivedPayments(
    ...args: Parameters<typeof getReceivedPaymentsAction>
) {
    return getReceivedPaymentsAction(...args);
}

export async function getSentPayments(
    ...args: Parameters<typeof getSentPaymentsAction>
) {
    return getSentPaymentsAction(...args);
}

export async function recordCustomerPayment(
    ...args: Parameters<typeof recordCustomerPaymentAction>
) {
    return recordCustomerPaymentAction(...args);
}

export async function recordSupplierPayment(
    ...args: Parameters<typeof recordSupplierPaymentAction>
) {
    return recordSupplierPaymentAction(...args);
}

export async function deletePayment(
    ...args: Parameters<typeof deletePaymentAction>
) {
    ...
    async function updateOverdueStatuses() {
        return safeAction(async () => {
            ...
            try {
                ...
                logger.error('Failed to update overdue statuses', {
                    error,
                    module: 'FinanceActions',
                });
                throw new BusinessRuleError(
                    'Gagal memperbarui status jatuh tempo. Periksa batasan sistem.',
                );
            }
        });
    },
...
export const getProductionCostReport = withTenant(
    async function getProductionCostReport(
        ...
        return safeAction(async () => {
            ...
            const data = await CostReportingService.getFinishedGoodsCosting(
                start,
                end,
            );
...
export const getOrderCosting = withTenant(async function getOrderCosting(
    orderId: string,
) {
    return safeAction(async () => {
        await requireAuth();
