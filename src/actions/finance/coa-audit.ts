...
const REQUIRED_ACCOUNTS: RequiredAccount[] = [
    ...
    { code: '11320', name: 'Work in Progress (WIP)', type: 'ASSET', category: 'CURRENT_ASSET', description: 'WIP account for manufacturing' },
    { code: '11330', name: 'Finished Goods Inventory', type: 'ASSET', category: 'CURRENT_ASSET', description: 'Inventory account for finished goods' },
    { code: '11340', name: 'Packaging Materials Inventory', type: 'ASSET', category: 'CURRENT_ASSET', description: 'Inventory account for packaging materials' },
