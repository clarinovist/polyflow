...
export const getFinanceDashboardStats = withTenant(
    async function getFinanceDashboardStats(dateRange?: {
        startDate?: Date;
        endDate?: Date;
    }) {
        return safeAction(async () => {
            ...
            const revenue =
                (Number(revenueAgg._sum.credit) || 0) -
                (Number(revenueAgg._sum.debit) || 0);
            ...
            const totalReceivables =
                Number(arAgg._sum.debit || 0) - Number(arAgg._sum.credit || 0);
            ...
            const totalPayables =
                Number(apAgg._sum.credit || 0) - Number(apAgg._sum.debit || 0);
            ...
            const netCashPosition =
                (Number(cashAgg._sum.debit) || 0) -
                (Number(cashAgg._sum.credit) || 0);
            return {
                revenue,
