...
export const getMaklonReport = withTenant(
    async function getMaklonReport(filters?: {
        startDate?: string;
        endDate?: string;
        customerId?: string;
    }) {
...
export const getMaklonCustomers = withTenant(
    async function getMaklonCustomers() {
        try {
