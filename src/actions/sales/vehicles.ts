 ...
 */
export const getVehicles = withTenant(async function getVehicles(filters?: {
        ...
        return prisma.vehicle.findMany({
            where: {
                ...(filters?.ownershipType && {
                    ownershipType: filters.ownershipType as OwnershipType,
                }),
                ...(filters?.status && {
 ...
 */
export const createVehicle = withTenant(async function createVehicle(
    ...
    return safeAction(async () => {
        ...
        if (existing) {
            throw new BusinessRuleError(
                `Nomor polisi "${result.data.plateNumber}" sudah terdaftar. Gunakan nomor lain.`,
            );
        }
 ...
 */
export const updateVehicle = withTenant(async function updateVehicle(
    id: string,
    data: CreateVehicleValues,
) {
    return safeAction(async () => {
        ...
        if (duplicate) {
            throw new BusinessRuleError(
                `Nomor polisi "${result.data.plateNumber}" sudah digunakan kendaraan lain.`,
            );
        }
 ...
 */
export const deleteVehicle = withTenant(async function deleteVehicle(
    id: string,
) {
    return safeAction(async () => {
