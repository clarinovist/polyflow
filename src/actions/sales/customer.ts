...
export const getCustomerById = withTenant(async function getCustomerById(
    id: string,
) {
    return safeAction(async () => {
        await requireAuth();
...
export const createCustomer = withTenant(async function createCustomer(
...
export const updateCustomer = withTenant(async function updateCustomer(
