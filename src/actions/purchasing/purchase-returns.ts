...
export const getPurchaseReturns = withTenant(async function getPurchaseReturns(
...
export const createPurchaseReturnAction = withTenant(
    async function createPurchaseReturnAction(
...
export const updatePurchaseReturnAction = withTenant(
    async function updatePurchaseReturnAction(
