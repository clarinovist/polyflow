...
export const PERMISSION_CATALOG: PermissionNode[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { key: '/production/output-report', label: 'Rekap Hasil Produksi' },
    ...
    },
    {
        ...
        children: [
            ...
            {
                key: '/warehouse/maklon/receipts',
                label: 'Penerimaan Maklon (WH)',
            },
            { key: '/warehouse/maklon/returns', label: 'Retur Maklon (WH)' },
            {
                ...
                children: [
                    {
                        key: '/warehouse/inventory/transfer',
                        label: 'Transfer Stok',
                    },
                    {
                        key: '/warehouse/inventory/adjustment',
                        label: 'Adjustment',
                    },
                    { key: '/warehouse/inventory/aging', label: 'Aging' },
                    {
                        key: '/warehouse/inventory/history',
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        key: '/finance/reports/income-statement',
                        label: 'Laba Rugi',
                    },
                    { key: '/finance/reports/cash-flow', label: 'Arus Kas' },
                    {
                        key: '/finance/reports/trial-balance',
                        label: 'Trial Balance',
                    },
                    {
                        key: '/finance/reports/general-ledger',
                        label: 'Buku Besar',
                    },
                    { key: '/finance/reports/hpp', label: 'HPP' },
                    { key: '/finance/reports/tax', label: 'Pajak' },
                    {
                        key: '/finance/reports/maklon',
                        label: 'Profitabilitas Maklon',
                    },
                ],
            },
            {
