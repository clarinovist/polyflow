...
export const createProductionProcessSchema = z.object({
    ...
    executionMode: z
        .enum(['GENERIC', 'INDIVIDUAL_OUTPUT', 'MATERIAL_CONVERSION'])
        .default('GENERIC'),
});
...
export type CreateProductionProcessValues = z.infer<
    typeof createProductionProcessSchema
>;
export type UpdateProductionProcessValues = z.infer<
...
export type CreateProductionRunValues = z.infer<
    typeof createProductionRunSchema
>;
export type CancelProductionRunValues = z.infer<
    typeof cancelProductionRunSchema
>;
export type CreateMachineCapabilityValues = z.infer<
    typeof createMachineCapabilitySchema
>;
