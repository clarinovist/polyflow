...
export const createReservationSchema = z.object({
    ...
    reservedFor: z.nativeEnum(ReservationType, {
...
export type AdjustStockWithBatchValues = z.infer<
    typeof adjustStockWithBatchSchema
>;
...
export const bulkTransferStockSchema = z
    ...
    .refine(
        ...
        {
            message:
                'Duplicate product variants are not allowed in bulk transfer',
            path: ['items'],
        },
    );
...
export const bulkAdjustStockSchema = z
    ...
    .refine(
        ...
        {
            message:
                'Duplicate product variants are not allowed in bulk adjustment',
            path: ['items'],
        },
    );
...
export const createLocationSchema = z.object({
    ...
    slug: z
        .string()
        .optional()
        .transform((slug) => (slug ? sanitizeHtml(slug) : undefined)),
    description: z
        .string()
        .optional()
