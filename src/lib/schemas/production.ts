...
export const createProductionOrderSchema = z
    .object({
        ...
        plannedEnteredQuantity: z.coerce
            .number()
            .positive('Entered planned quantity must be positive')
            .optional(),
        plannedEnteredUnit: z.nativeEnum(Unit).optional(),
        plannedConversionFactorSnapshot: z.coerce
            .number()
            .positive('Planning conversion factor must be positive')
            .optional(),
        ...
        estimatedConversionCost: z.coerce
            .number()
            .nonnegative()
            .optional()
            .default(0),
    ...
    items: z
        .array(
            z.object({
                productVariantId: z
                    .string()
                    .min(1, 'Material variant is required'),
                quantity: z.coerce
                    .number()
...
export type CreateProductionOrderValues = z.infer<
    typeof createProductionOrderSchema
>;
export type UpdateProductionOrderValues = z.infer<
...
export const consolidatedBatchMaterialIssueSchema = z.object({
    productionOrderIds: z
        ...
        .min(1, 'At least one Production Order is required'),
    locationId: z.string().min(1, 'Source location is required'),
    items: z
        .array(
            z.object({
...
export type ConsolidatedBatchMaterialIssueValues = z.infer<
    typeof consolidatedBatchMaterialIssueSchema
>;
...
export const productionOutputSchema = z.object({
    ...
    baseQuantityProduced: z.coerce
        .number()
        .positive('Base quantity must be positive')
        .optional(),
