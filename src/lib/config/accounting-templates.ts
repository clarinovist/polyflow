...
export const JOURNAL_TEMPLATES: JournalTemplate[] = [
    {
        ...
        lines: [
            {
                accountRole: 'office-salaries',
                accountCode: '62100',
                debit: true,
                description: 'Beban Gaji',
            },
            {
                accountRole: 'petty-cash',
                accountCode: '11110',
                credit: true,
    ...
    },
    {
        ...
        lines: [
            {
                accountRole: 'raw-material',
                accountCode: '11300',
                debit: true,
                description: 'Persediaan Bahan Baku',
            },
            {
                accountRole: 'petty-cash',
                accountCode: '11110',
                credit: true,
                description: 'Bayar Bahan Baku',
            },
        ],
    },
    {
        ...
        lines: [
            {
                accountRole: 'packaging',
                accountCode: '11340',
                debit: true,
                description: 'Persediaan Kemasan',
            },
            {
                accountRole: 'petty-cash',
                accountCode: '11110',
                credit: true,
                description: 'Bayar Kemasan',
            },
        ],
    },
    {
        ...
        lines: [
            {
                accountRole: 'inventory-consumables',
                accountCode: '11360',
                debit: true,
                description: 'Persediaan Perlengkapan',
            },
            {
                accountRole: 'petty-cash',
                accountCode: '11110',
                credit: true,
                description: 'Bayar Perlengkapan',
            },
        ],
    },
    {
        ...
        lines: [
            {
                accountRole: 'factory-electricity',
                accountCode: '53200',
                debit: true,
    ...
    },
    {
        ...
        lines: [
            {
                accountRole: 'factory-maintenance',
                accountCode: '53300',
                debit: true,
                description: 'Beban Pemeliharaan',
            },
            {
                accountRole: 'petty-cash',
                accountCode: '11110',
                credit: true,
                description: 'Bayar Pemeliharaan',
            },
        ],
    },
    {
        ...
        lines: [
            {
                accountRole: 'shipping-expense',
                accountCode: '61100',
                debit: true,
                description: 'Beban Transportasi',
            },
            {
                accountRole: 'petty-cash',
                accountCode: '11110',
                credit: true,
                description: 'Bayar Transportasi',
            },
        ],
    },
];
