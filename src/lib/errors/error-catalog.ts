...
export const ErrorCatalog = {
    ...
    GENERIC_UNEXPECTED:
        'Terjadi kesalahan tak terduga. Tim teknis telah diberitahu.',
    ...
    // Validation
    VALIDATION_ERROR:
        'Terdapat kesalahan pada input data. Silakan periksa formulir.',
    ...
    VALUE_TOO_LONG:
        'Teks terlalu panjang untuk salah satu field. Perpendek input lalu coba lagi.',
    NULL_CONSTRAINT:
        'Field wajib tidak boleh kosong. Periksa formulir lalu coba lagi.',
    FOREIGN_KEY:
        'Operasi ditolak karena relasi data. Data terkait tidak ditemukan, atau masih dipakai entitas lain.',
} as const;
