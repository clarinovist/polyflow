...
const salesNavItems: NavItem[] = [
  ...
  { id: 'sales-mts-unpaid', label: 'MTS Belum Lunas', href: '/sales/orders?view=mts-unpaid', workspace: 'sales', section: 'transaksi', owner: 'sales' },
...
const warehouseNavItems: NavItem[] = [
  ...
  { id: 'wh-maklon-receipts', label: 'Penerimaan Maklon', href: '/dashboard/maklon/receipts', workspace: 'warehouse', section: 'maklon', owner: 'warehouse' },
  { id: 'wh-maklon-returns', label: 'Retur Maklon', href: '/dashboard/maklon/returns', workspace: 'warehouse', section: 'maklon', owner: 'warehouse' },
