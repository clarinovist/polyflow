...
const productionNavItems: NavItem[] = [
    ...
    {
        id: 'prod-output-report',
        label: 'Rekap Hasil Produksi',
 ...
 */
export function findDuplicateHrefs(): Array<{
    href: string;
    items: NavItem[];
}> {
