...
export function redactSensitiveFields(
  ...
  if (level === 'personal' || level === 'full') {
    ...
    result = result.replace(/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b/g, '[REDACTED-EMAIL]');
 ...
 */
export function getRetentionExpiry(policy: keyof typeof RETENTION_POLICY): Date {
