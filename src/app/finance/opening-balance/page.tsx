...
export default async function OpeningBalancePage() {
    ...
    const [accountsRes, customersRes, suppliersRes, arResolved, apResolved] =
        await Promise.all([
        ...
        <div className="container mx-auto py-8 max-w-7xl">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground mt-2">
                    Set up your initial account balances and outstanding
                    invoices for a complete migration.
                </p>
            </div>
            ...
            <div className="bg-muted/30 p-6 rounded-lg border border-dashed">
                <h3 className="font-semibold mb-2">
                    Need to see previous entries?
                </h3>
                <p className="text-sm text-muted-foreground mb-4">
                    The history view has been moved to the &quot;Journal
                    Entries&quot; page for better auditability. Look for entries
                    with reference &quot;OPENING-GEN&quot; or specific Invoice
                    numbers.
                </p>
            </div>
        </div>
