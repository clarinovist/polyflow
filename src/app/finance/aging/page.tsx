            ...
            <table className="w-full text-sm">
                <thead>
                    <tr className="bg-muted/30 text-muted-foreground">
                        ...
                        <th className="h-9 px-4 text-center font-medium">
                            Status
                        </th>
                        <th className="h-9 px-4 text-center font-medium">
                            Aging
                ...
                <tbody>
                    {sorted.map((inv) => (
                        ...
                        >
                            ...
                            <td
                                className={`px-4 py-2.5 text-right font-mono ${getBucketColor(inv.bucket)}`}
                            >
                                {inv.daysOverdue < 0
                                    ? `${Math.abs(inv.daysOverdue)} hari lagi`
                            ...
                            <td className="px-4 py-2.5 text-center">
                                <span
                                    className={`text-xs ${getBucketColor(inv.bucket)}`}
                                >
                            ...
                            <td className="px-4 py-2.5 text-center">
                                <Link
                                    href={
                                        type === 'AR'
                                            ? `/sales/invoices/${inv.invoiceId}`
                                            : `/purchasing/invoices/${inv.invoiceId}`
                                    }
        ...
        <div className="space-y-6 max-w-7xl mx-auto pb-10">
            <div>
                ...
                <p className="text-muted-foreground">
                    Pantau piutang dan hutang per nota. Klik baris untuk melihat
                    detail.
                </p>
            </div>
