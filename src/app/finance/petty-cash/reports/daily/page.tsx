...
export default function DailyPettyCashReportPage() {
    ...
    const runReportAction = async (
        ...
        try {
            const result = (await action(reportId)) as Record<
                string,
                unknown
            > | null;
            if (result && 'success' in result && result.success) {
                toast({
                    title: 'Berhasil',
                    description: `${actionName} berhasil.`,
                });
                await fetchData();
            } else {
                const errorMsg =
        ...
        <div className="space-y-6 max-w-7xl mx-auto pb-10">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 print:hidden">
                ...
                <div className="flex gap-2 items-center">
                            ...
                            {data.savedReport === null && (
                                <Button
                                    ...
                                    onClick={async () => {
                                        ...
                                        try {
                                            const result =
                                                await createPettyCashDailyReportAction(
                                            ...
                                            if (
                                                ...
                                                toast({
                                                    title: 'Berhasil',
                                                    description:
                                                        'Laporan kas kecil berhasil dibuat.',
                                                });
                                                await fetchData();
                                            } else {
                                                const errorMsg =
                                ...
                                data.status !== 'VOIDED' && (
                                    <Button
                                        ...
                                        onClick={async () => {
                                            ...
                                            if (
                                                !confirm(
                                                    'Apakah anda yakin ingin void laporan ini?',
                                                )
                                            )
                                                return;
                                            setActionLoading(true);
                                            try {
                                                const res =
                                                    await voidPettyCashDailyReportAction(
                                                        reportId,
                                                    );
                                                if (
                                                    res &&
                    ...
                    <Button
                        variant="default"
                        className="gap-2 bg-purple-600 hover:bg-purple-700 text-white dark:bg-purple-400 dark:hover:bg-purple-300"
                        onClick={handlePrint}
                ...
                <div className="flex justify-between items-start">
                    <div>
                        <h2 className="text-2xl font-bold tracking-wider">
                            POLYFLOW MANUFACTURING
                        </h2>
                        <p className="text-xs text-gray-600">
                            Sistem ERP Internal Finance
                        </p>
                    </div>
            ...
            {loading ? (
                ...
                <div className="py-20 text-center border-2 border-dashed rounded-lg text-muted-foreground">
                    Gagal memuat data laporan untuk tanggal ini. Silakan coba
                    lagi.
                </div>
            ) : (
                <div className="space-y-6 print-report-container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 print:grid-cols-4 print:gap-4">
                        ...
                        <Card className="shadow-sm border-emerald-100 bg-emerald-50/20 dark:border-emerald-800/50 dark:bg-emerald-900/20 print:bg-white print:border-border">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium text-emerald-800 dark:text-emerald-400 print:text-card-foreground">
                                    Total Kas Masuk
                                </CardTitle>
                        ...
                        <Card className="shadow-sm border-rose-100 bg-rose-50/20 dark:border-rose-800/50 dark:bg-rose-900/20 print:bg-white print:border-border">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium text-rose-800 dark:text-rose-400 print:text-card-foreground">
                                    Total Kas Keluar
                                </CardTitle>
                        ...
                        <Card className="shadow-sm bg-gradient-to-br from-purple-500/10 to-indigo-500/10 dark:from-purple-400/20 dark:to-indigo-400/20 border-purple-200 dark:border-purple-800/50 print:bg-white print:border-border">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium text-purple-900 dark:text-purple-300 print:text-card-foreground">
                                    Saldo Akhir
                                </CardTitle>
                                    ...
                                    <TableBody>
                                        {data.transactions.length === 0 ? (
                                            ...
                                            data.transactions.map((t) => (
                                                <TableRow
                                                    key={t.id}
                                                    className="hover:bg-muted/10 print:hover:bg-white"
                                                >
                                                        ...
                                                        <div className="flex items-center justify-center gap-1">
                                                            ...
                                                            'POSTED' ? (
                                                                <>
                                                                    ...
                                                                    <span className="text-[10px] font-semibold text-emerald-800 dark:text-emerald-400 uppercase print:text-black">
                                                                        Posted
                                                                    </span>
                                                                </>
                                                            ) : (
                                                                <>
                                                                    ...
                                                                    <span className="text-[10px] font-semibold text-amber-800 dark:text-amber-400 uppercase print:text-black">
                                                                        Draft
                                                                    </span>
                                                                </>
                                                            )}
