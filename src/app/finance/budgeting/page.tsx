      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Pantau pengeluaran departemen dan perusahaan
          </p>
        </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b bg-muted/20 text-muted-foreground">
                    ...
                    <th className="h-10 px-4 text-right font-medium">Aktual</th>
                    <th className="h-10 px-4 text-right font-medium">
                      Selisih
                    </th>
                    <th className="h-10 px-4 text-right font-medium">% Sisa</th>
                  </tr>
                </thead>
                <tbody>
                  {data.map((row, i) => (
                    ...
                    >
                      ...
                      <td className="p-4 align-middle text-right font-mono">
                        <div
                          className={`flex items-center justify-end gap-1 ${row.variance < 0 ? "text-rose-500" : "text-emerald-500"}`}
                        >
                          {row.variance < 0 ? (
                      ...
                      <td className="p-4 align-middle text-right font-mono">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-semibold ${row.variancePercentage < 0 ? "bg-rose-100 text-rose-700" : "bg-emerald-100 text-emerald-700"}`}
                        >
