...
export function FinancialPurchaseInvoicePageClient({
    invoice,
}: {
    invoice: Parameters<typeof FinancialPurchaseInvoiceDetail>[0]['invoice'];
}) {
    ...
    return (
        <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Financial View · Tempo diperbaiki dari supplier
                            default
                        </p>
                    </div>
                </div>
            ...
            <EditPurchaseInvoiceDueDateDialog
                open={editOpen}
