            ...
            <main className="flex-1 max-w-md w-full mx-auto p-5 flex flex-col justify-center gap-6">
                <div className="space-y-1.5">
                    ...
                    <p className="text-sm text-slate-400">
                        ...
                        . Pilih ruang kerja operasional Anda:
                    </p>
                </div>
                ...
                <div className="space-y-3.5">
                    {portals.map((portal) => {
                        const IconComponent =
                            (LucideIcons[
                                portal.icon as keyof typeof LucideIcons
                                ...
                                <div className="flex items-center justify-between gap-3">
                                    <div className="flex items-center gap-3.5">
                                        ...
                                        <div className="space-y-0.5 min-w-0">
                                            ...
                                            {portal.status === 'BETA' && (
                                                <span className="inline-block text-[10px] font-medium px-1.5 py-0.5 rounded bg-amber-500/20 text-amber-400 border border-amber-500/30">
                                                    BETA
                                                </span>
                                            )}
                                        </div>
