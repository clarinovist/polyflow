    ...
    return (
        <div className="p-4 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
                ...
                <Link
                    href={`/field/sales/orders/create?customer=${customer.id}`}
            ...
            <div className="border rounded-xl p-4 space-y-3">
                ...
                <div className="flex justify-between items-center text-sm pt-1">
                    ...
                    <p
                        className={`font-bold text-sm ${totalOutstanding > 0 ? 'text-rose-600 dark:text-rose-400' : 'text-emerald-600 dark:text-emerald-400'}`}
                    >
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-2 pt-1 border-t text-xs">
                                        <div>
                                            ...
                                            <p
                                                className={`font-medium ${isOverdue ? 'text-destructive font-semibold' : 'text-foreground'}`}
                                            >
                                                {inv.dueDate
                                                    ? format(
            ...
            {recentOrders.filter((o) =>
                ['QUOTATION', 'QUOTATION_SENT'].includes(o.status),
            ).length > 0 && (
                <div>
                    ...
                    <div className="space-y-2">
                        {recentOrders
                            .filter((o) =>
                                ['QUOTATION', 'QUOTATION_SENT'].includes(
                                    o.status,
                                ),
                            )
                            .map((order) => (
                                ...
                                >
                                    ...
                                    <div className="text-right">
                                        ...
                                        <Badge
                                            variant="outline"
                                            className="text-[10px] mt-0.5 bg-blue-50 text-blue-700 dark:bg-blue-950/30 dark:text-blue-400"
                                        >
                                            Penawaran
                                        </Badge>
                                    </div>
