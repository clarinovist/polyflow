    ...
    const handleAddProduct = async () => {
        ...
        try {
            ...
            if (result.success && result.data) {
                ...
                setNewSellPrice('');
                toast.success(
                    `Produk "${newProduct.productName}" berhasil dibuat`,
                );
            } else if (!result.success) {
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-[10px] text-muted-foreground">
                            Bisa dikosongkan untuk order cepat. Pilih gudang
                            saat ingin kirim barang.
                        </p>
                    </div>
            ...
            {step === 3 && (
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 border rounded-xl bg-muted/30">
                        <div>
                            <p className="text-sm font-medium">
                                Simpan sebagai penawaran
                            </p>
                            <p className="text-[10px] text-muted-foreground">
                                Harga belum final, bisa dilengkapi sebelum
                                konfirmasi
                            </p>
                        </div>
                        <button
