        ...
        <div className="flex flex-col gap-8">
            ...
            <Card className="bg-background/40 backdrop-blur-xl border-white/10 dark:border-white/5 overflow-hidden shadow-xl">
                <CardHeader className="bg-muted/20 border-b border-white/10">
                    ...
                    <CardDescription>Active operators and production support team.</CardDescription>
                </CardHeader>
                            ...
                            <TableBody>
                                {employees.length === 0 ? (
                                    ...
                                    employees.map((employee: Employee) => (
                                        <TableRow key={employee.id} className="group border-white/5 hover:bg-primary/[0.02]">
                                            <TableCell>
                                            ...
                                            <TableCell>
                                                <Badge variant={employee.status === 'ACTIVE' ? 'default' : 'secondary'} className={employee.status === 'ACTIVE' ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/10 text-[10px] h-5 font-bold" : "text-[10px] h-5 font-bold"}>
                                                    {employee.status}
                                                </Badge>
                                            </TableCell>
