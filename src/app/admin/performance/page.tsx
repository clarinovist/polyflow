...
import { getPerformanceStatusLevel } from '@/lib/utils/performance-status';
import {
    Card,
    CardContent,
    CardHeader,
...
const P95_TEXT_CLASS: Record<'ok' | 'warn' | 'critical' | 'unknown', string> = {
    ok: '',
                ...
                <CardContent>
                    <Table>
                        ...
                        <TableBody>
                            ...
                            {summaries.map((s) => {
                                const p95Level = getPerformanceStatusLevel(
                                    s.p95Ms,
                                );
                                return (
