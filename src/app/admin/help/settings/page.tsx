...
const SETTING_META: Record<
    string,
    { label: string; desc: string; type: 'bool' | 'number' | 'string' | 'json' }
> = {
    virtualCsEnabled: {
        label: 'Virtual CS Enabled',
        desc: 'Master toggle Virtual CS',
        type: 'bool',
    },
    kbRetrievalEnabled: {
        label: 'KB Retrieval Enabled',
        desc: 'Apakah chat wajib coba KB dulu',
        type: 'bool',
    },
    autoLearnDraftEnabled: {
        label: 'Auto-learn Draft',
        desc: 'Buat draft otomatis dari cluster (Phase 3)',
        type: 'bool',
    },
    autoPublishEnabled: {
        label: 'Auto-publish (DANGER)',
        desc: 'HARUS OFF — supervised only',
        type: 'bool',
    },
    minClusterSizeForDraft: {
        label: 'Min Cluster Size for Draft',
        desc: 'Jumlah Q mirip sebelum buat draft',
        type: 'number',
    },
    feedbackThumbsEnabled: {
        label: 'Feedback Thumbs',
        desc: 'Tampilkan UP/DOWN di chat',
        type: 'bool',
    },
    guardrailMode: {
        label: 'Guardrail Mode',
        desc: 'intent_v2 recommended',
        type: 'string',
    },
    maxAgentToolLoops: {
        label: 'Max Agent Tool Loops',
        desc: 'Max iterasi agent LLM',
        type: 'number',
    },
    channels: {
        label: 'Channels',
        desc: 'Channel aktif (web, telegram)',
        type: 'json',
    },
    maxQuestionLength: {
        label: 'Max Question Length',
        desc: 'Batas karakter per pertanyaan',
        type: 'number',
    },
};
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                        Feature flags & config Virtual CS / KB / auto-learn
                    </p>
                </div>
