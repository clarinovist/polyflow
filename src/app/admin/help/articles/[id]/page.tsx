...
import {
    ...
    publishHelpArticle,
    archiveHelpArticle,
} from '@/actions/admin/help-articles';
...
export default function EditHelpArticlePage() {
    ...
    const [article, setArticle] = useState<Awaited<
        ReturnType<typeof getHelpArticle>
    > | null>(null);
    ...
    useEffect(() => {
        getHelpArticle(id)
            ...
            .catch((e) =>
                setError(
                    e instanceof Error ? e.message : 'Gagal memuat artikel.',
                ),
            )
        ...
        <HelpArticleEditor
            ...
            onPublish={async (articleId) => {
                try {
                    ...
                    return {
                        error:
                            e instanceof Error ? e.message : 'Gagal publish.',
                    };
                }
            }}
            onArchive={async (articleId) => {
                try {
                    ...
                    return {
                        error:
                            e instanceof Error ? e.message : 'Gagal arsipkan.',
                    };
                }
            }}
        />
