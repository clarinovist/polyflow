            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            ...
                            {Math.floor((system.uptimeSeconds % 3600) / 60)}m
                        </div>
                        <p className="text-xs text-muted-foreground mt-1">
                            {L.processUptime}
                        </p>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-2">
                            {Math.round(
                                (memory.osTotalBytes - memory.osFreeBytes) /
                                    1024 /
                                    1024 /
                                    1024,
                            )}
                            GB /{' '}
                            {Math.round(
                                memory.osTotalBytes / 1024 / 1024 / 1024,
                            )}
                            GB
                        </p>
                    </CardContent>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-2">
                            {Math.round(memory.heapUsedBytes / 1024 / 1024)}MB /{' '}
                            {Math.round(memory.heapTotalBytes / 1024 / 1024)}MB
                        </p>
                    </CardContent>
                </Card>
            </div>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between border-b pb-2 text-sm">
                                ...
                                <span className="font-medium">
                                    {Math.floor(
                                        system.osUptimeSeconds / 3600 / 24,
                                    )}{' '}
                                    days{' '}
                                    {Math.floor(
                                        (system.osUptimeSeconds % (3600 * 24)) /
                            ...
                            <div className="flex justify-between pb-2 text-sm">
                                ...
                                <span className="font-medium">
                                    {Math.round(memory.rssBytes / 1024 / 1024)}{' '}
                                    MB
                                </span>
                            </div>
                        </div>
