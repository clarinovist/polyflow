            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                {fields.map((field, index) => {
                    ...
                    return (
                        <div
                            key={field.id}
                            className="relative p-6 rounded-2xl bg-white/5 dark:bg-zinc-900/5 border border-purple-500/20 dark:border-purple-500/30 backdrop-blur-md shadow-2xl flex flex-col gap-6 transition-all hover:bg-purple-900/10 dark:hover:bg-purple-900/20"
                        >
                            {/* Header Panel */}
                            <div className="flex justify-between items-center border-b border-purple-500/20 dark:border-purple-500/30 pb-4">
                                <h3 className="text-xl font-bold text-purple-600 dark:text-purple-400 flex items-center gap-2">
                                    <span className="bg-purple-500/20 dark:bg-purple-500/30 text-purple-600 dark:text-purple-300 h-8 w-8 rounded-full flex items-center justify-center text-sm">
                                        {index + 1}
                                    </span>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-purple-600 dark:text-purple-200/70">
                                                Work Order (SPK)
                                            </FormLabel>
                                            <Select
                                                onValueChange={(val) => {
                                        ...
                                        <FormItem>
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 p-3 bg-purple-950/20 dark:bg-purple-950/30 rounded-lg border border-purple-500/10 dark:border-purple-500/20">
                                                ...
                                                {eligibleHelpers.length ===
                                                    0 && (
                                                    <p className="text-purple-400 dark:text-purple-200/30 text-xs col-span-4">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-purple-950/20 dark:bg-purple-950/30 p-4 rounded-xl border border-purple-500/10 dark:border-purple-500/20">
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input
                                                    type="number"
                                                    step="any"
                                                    className="bg-slate-900/80 dark:bg-zinc-800/80 border-purple-500/30 dark:border-purple-500/40 text-green-500 dark:text-green-400 font-black text-xl shadow-[0_0_15px_rgba(74,222,128,0.1)]"
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    control={form.control}
                                    name={`reports.${index}.scrapQuantity`}
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-purple-600 dark:text-purple-200/70">
                                                Scrap Potong (Kg)
                                            ...
                                            <FormControl>
                                                <Input
                                                    type="number"
                                                    step="any"
                                                    className="bg-slate-900/80 dark:bg-zinc-800/80 border-purple-500/20 dark:border-purple-500/30 text-red-500 dark:text-red-400"
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage />
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input
                                                    type="datetime-local"
                                                    className="bg-slate-900/80 dark:bg-zinc-800/80 border-purple-500/20 dark:border-purple-500/30 text-white"
                                                    value={
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-purple-950/30 dark:bg-purple-950/40 p-6 rounded-2xl border-t-4 border-purple-500/50 dark:border-purple-500/60 shadow-lg backdrop-blur-xl sticky bottom-4 z-50">
                    ...
                    >
                        {isSubmitting ? (
                            ...
                            <>
                                <CheckCircle2 className="h-6 w-6 mr-2" /> SUBMIT
                                SEMUA LAPORAN
                            </>
                        )}
                    </Button>
