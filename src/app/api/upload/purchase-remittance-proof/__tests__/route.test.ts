...
const mockBuildKey = vi
    .fn()
    .mockReturnValue('tenant/remittance-proof/wh-1/123.jpg');
...
describe('/api/upload/purchase-remittance-proof', () => {
    beforeEach(() => {
        ...
        mockBuildKey.mockReturnValue('tenant/remittance-proof/wh-1/123.jpg');
    ...
    it('infers image type from filename when MIME is empty', async () => {
        const fd = new FormData();
