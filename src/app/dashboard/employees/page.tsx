...
export default async function EmployeesPage({
    ...
    const employees: EmployeeRecord[] = rawEmployees.map(
        (e: Record<string, unknown>) => ({
            ...
            dailyRate:
                typeof e.dailyRate === 'object' &&
                e.dailyRate !== null &&
                'toNumber' in (e.dailyRate as object)
                    ? (e.dailyRate as { toNumber(): number }).toNumber()
                    : Number(e.dailyRate ?? 0),
            monthlySalary:
                e.monthlySalary != null
                    ? typeof e.monthlySalary === 'object' &&
                      'toNumber' in (e.monthlySalary as object)
