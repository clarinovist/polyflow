                ...
                <div className="prose prose-invert max-w-none space-y-6">
                    <section>
                        ...
                        <p className="text-zinc-300">
                            By accessing and using PolyFlow ERP (&quot;the
                    ...
                    <section>
                        ...
                        <p className="text-zinc-300">
                            Permission is granted to temporarily use the Service
                            for personal, non-commercial transitory viewing
                            only. This is the grant of a license, not a transfer
                            of title.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-zinc-300">
                            In no event shall PolyFlow be liable for any damages
                    ...
                    <section>
                        ...
                        <p className="text-zinc-300">
                            PolyFlow reserves the right to modify these terms at
                            any time. Continued use of the Service constitutes
