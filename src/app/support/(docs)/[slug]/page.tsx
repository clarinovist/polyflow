...
export default async function ArticleDetailPage({
    ...
    const backHref =
        sp.from === 'troubleshooting' ? '/support/troubleshooting' : '/support';
    const backLabel =
        sp.from === 'troubleshooting'
            ...
            <div className="min-w-0 max-w-3xl flex-1">
                ...
                <div className="mt-4 rounded-2xl border border-slate-200 dark:border-zinc-700 bg-white/60 dark:bg-zinc-900/60 p-5 text-center">
                    <p className="text-sm text-muted-foreground mb-3">
                        Masih butuh bantuan? Tanya Virtual CS untuk jawaban
                        lebih spesifik.
                    </p>
                    <Link
                        href={`/support/cs?q=${encodeURIComponent(article.title)}`}
                    >
