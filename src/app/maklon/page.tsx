        ...
        items: [
            {
                ...
                description:
                    'Pantau penerimaan bahan milik customer untuk order Maklon Jasa',
            },
            {
                ...
                description:
                    'Catat penerimaan material maklon baru ke stok customer-owned',
            },
            {
                href: '/maklon/returns',
                icon: RotateCcw,
                ...
                description:
                    'Kelola retur sisa bahan customer setelah proses maklon',
            },
            {
        ...
        items: [
            {
                ...
                description:
                    'Operasional gudang harian, termasuk alias maklon di portal stok',
            },
        ],
    },
];
