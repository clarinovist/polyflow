        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Ini akan mengubah status SPK menjadi Dibatalkan. Karena
                        belum ada material yang dikeluarkan dan belum ada output
                        yang dicatat, ini aman untuk menutup SPK duplikat atau
                ...
                <AlertDialogFooter>
                    ...
                    <AlertDialogAction
                        onClick={() =>
                            transition(
                                'CANCELLED',
                                `SPK ${order.orderNumber} dibatalkan`,
                            )
                        }
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                ...
                                menghapus permanen SPK beserta kebutuhan
                                materialnya.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
            ...
            <div className="flex items-center gap-2">
                ...
                <Button
                    ...
                    onClick={() =>
                        transition(
                            'COMPLETED',
                            `SPK ${order.orderNumber} diselesaikan`,
                        )
                    }
                    disabled={!!loading}
                    aria-busy={!!loading}
