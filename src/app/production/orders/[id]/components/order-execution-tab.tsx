                        ...
                        <div className="rounded-lg border border-amber-200 bg-amber-50 p-3 flex items-start gap-3 dark:border-amber-800/50 dark:bg-amber-900/20">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-amber-700 dark:text-amber-300 mt-1">
                                    Hubungi Gudang untuk issue bahan sebelum
                                    Rilis.
                                </p>
                                <Button
                                    variant="link"
                                    ...
                                    {isFloorPath ? (
                                        <>
                                            <p className="font-medium">
                                                Jalur bahan: Staging lantai
                                                (Path B)
                                            </p>
                                            <p className="text-muted-foreground text-xs leading-relaxed">
                                                WIP hasil mixing dapat
                                                di-staging di lantai. Ambil dari
                                                lantai saat produksi
                                                Extrusion/Packing.
                                            </p>
                                        </>
                                    ) : (
                                        <>
                                            ...
                                            <p className="text-muted-foreground text-xs leading-relaxed">
                                                Issue bahan baku dilakukan di
                                                Gudang. SPK menunggu bahan
                                                hingga semua kebutuhan tersedia.
                                            </p>
                                        </>
                                    )}
                                    <Button
