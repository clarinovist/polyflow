                ...
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 flex items-start gap-3 dark:border-amber-800/50 dark:bg-amber-900/20">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-xs text-amber-700 dark:text-amber-300 mt-1">
                            Path A (Mixing): pengambilan bahan baku di Gudang.
                            ...
                            {isFloorPath ? (
                                <>
                                    ...
                                    <p className="text-muted-foreground text-xs leading-relaxed">
                                        WIP hasil mixing dapat di-staging di
                                        lantai. Ambil dari lantai saat produksi
                                        Extrusion/Packing.
                                    </p>
                                    <p className="text-muted-foreground text-xs leading-relaxed">
                                        Bahan tambahan (mis. pelembab) hanya via
                                        Gudang.
                                    </p>
                                </>
                            ) : (
                                <>
                                    ...
                                    <p className="text-muted-foreground text-xs leading-relaxed">
                                        Issue bahan baku dilakukan di Gudang.
                                        SPK menunggu bahan hingga semua
                                        kebutuhan tersedia.
                                    </p>
                                </>
                            )}
                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="bg-muted/50 text-muted-foreground">
                            <tr>
                                ...
                                <th className="p-3 text-right w-[25%]">
                                    Keluar
                                </th>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="font-mono bg-muted px-2 py-1 rounded text-xs font-semibold">
                                        ...
                                        {issue.productVariant.primaryUnit}
                                    </span>
                                </div>
                            </div>
                        ))}
