                ...
                <Alert className="py-2 border-blue-200 bg-blue-50/50 dark:border-blue-800/50 dark:bg-blue-900/20">
                    ...
                    <AlertDescription className="text-xs">
                        <span className="font-medium">
                            Dari Sales Order / Papan FG
                        </span>
                        <br />
                        SO {salesOrderContext?.orderNumber || salesOrderId}
                        {salesOrderContext?.productName &&
                            ` · Produk ${salesOrderContext.productName}`}
                        {salesOrderContext?.remainingQty != null &&
                            ` · Sisa ${salesOrderContext.remainingQty}`}
                        <br />
                        <span className="text-muted-foreground">
                            Prefill resep & target bila tersedia. Boleh ubah
                            sebelum buat.
                        </span>
                    </AlertDescription>
                </Alert>
