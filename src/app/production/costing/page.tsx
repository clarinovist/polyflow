...
const getCostingData = withTenantPage(
    async (startDate: Date, endDate: Date) => {
        return CostingService.getPeriodCosts(startDate, endDate);
    },
);
...
export default async function CostingPage(props: {
    ...
    const buildFilterHref = (
        ...
        const nextFlag =
            overrides.flag !== undefined ? overrides.flag : flagFilter;
            ...
            <Card className="border-amber-200/70">
                ...
                <CardContent className="space-y-6">
                    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    Semua variant dengan cost basis yang bisa
                                    diaudit
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    Biasanya residue stock tipis / sisa cost
                                    lama
                                </p>
                            </CardContent>
                        </Card>
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    {auditSummary.standardFallbackCount} variant
                                    masih fallback ke standard cost
                                </p>
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <Button
                            variant={
                                sourceFilter === 'inventory_average'
                                    ? 'default'
                                    : 'outline'
                            }
                            asChild
                        ...
                        <Button
                            variant={
                                flagFilter === 'low_stock_cost_outlier'
                                    ? 'default'
                                    : 'outline'
                            }
                            asChild
                        ...
                        <Button
                            variant={
                                flagFilter === 'inventory_standard_gap'
                                    ? 'default'
                                    : 'outline'
                            }
                            asChild
