...
import { ClipboardCheck, CheckSquare, TrendingUp, Home } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 pb-20">
            ...
            <nav className="fixed bottom-0 left-0 right-0 z-30 flex border-t bg-white py-2 shadow-lg dark:bg-slate-900 dark:border-slate-800">
                <Link
                    ...
                    className="flex flex-1 flex-col items-center gap-1 text-xs font-medium text-indigo-600 dark:text-indigo-400"
                >
