        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage active Work Orders and floor assignments.</p>
                </div>
            </div>
                                        ...
                                        <CardContent className="flex-1 p-4 lg:p-6 space-y-4">
                                            ...
                                            <div className="border-t border-slate-100 dark:border-slate-800 pt-3">
                                                <div className="flex items-center justify-between gap-3 mb-1.5">
                                                    <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Work Shift</div>
                                                ...
                                                {order.shifts.length === 0 ? (
                                                    <div className="text-[11px] text-muted-foreground">
                                                        No team assigned. Click Add Shift to set schedule.
                                                    </div>
                                                ) : (
                                                    <div className="space-y-1.5">
