...
import { getProductionHistory, getProductionHistoryFilterOptions, type ProductionHistoryFilter } from '@/actions/production/production-execution';
...
export default async function ProductionHistoryPage({ searchParams }: PageProps) {
  ...
  const data = historyResult.success && historyResult.data ? historyResult.data : { groups: [], summary: { totalGood: 0, totalScrap: 0, executionCount: 0, orderCount: 0, missingPhotoCount: 0 } };
