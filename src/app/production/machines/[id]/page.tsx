...
export default async function MachineHistoryPage({
            ...
            <div className="space-y-6">
                <Link href="/production/machines">
                    <Button variant="ghost" size="sm" className="gap-1">
                        <ArrowLeft className="h-4 w-4" /> Kembali ke Machine
                        Board
                    </Button>
                </Link>
                <Card>
    ...
    const totalYield = completedExecs.reduce(
        (sum: number, e: { quantityProduced: unknown }) =>
            sum + Number(e.quantityProduced || 0),
        0,
    );
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Semua eksekusi produksi yang pernah berjalan di mesin
                        ini.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <TableBody>
                            ...
                            {executions.length === 0 && (
                                <TableRow>
                                    ...
                                    >
                                        Belum ada riwayat produksi untuk mesin
                                        ini.
                                    </TableCell>
                                </TableRow>
                            )}
