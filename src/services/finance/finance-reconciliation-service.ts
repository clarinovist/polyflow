...
type InvoiceSource = {
    ...
    totalAmount: Prisma.Decimal; paidAmount: Prisma.Decimal; creditedAmount: Prisma.Decimal; priceAdjustmentAmount: Prisma.Decimal; allocatedAdjustment: Prisma.Decimal; allocatedCredit: Prisma.Decimal; paymentTotal: Prisma.Decimal;
    ...
    return tx.$queryRaw<InvoiceSource[]>(Prisma.sql`
        WITH source AS (
            ...
            SELECT * FROM source WHERE
                ...
                OR "paymentTotal" <> "paidAmount" OR "paymentTotal" + "creditedAmount" > "totalAmount" + "priceAdjustmentAmount"
                OR "priceAdjustmentAmount" <> "allocatedAdjustment"
