...
export async function reverseJournal(
  ...
  if (journal.status !== "POSTED")
    throw new BusinessRuleError(
      "Hanya jurnal POSTED yang dapat direverse",
      { journalId: id, currentStatus: journal.status },
      "INVALID_STATUS_TRANSITION",
    );
  if (journal.isAutoGenerated)
    throw new BusinessRuleError(
      "Tidak dapat mereverse jurnal otomatis secara langsung",
  ...
  if (!isOpen) {
    throw new BusinessRuleError(
      "Tidak dapat mereverse jurnal di periode fiskal yang sudah ditutup.",
      { journalId: id },
      "FISCAL_PERIOD_CLOSED",
    );
  }
...
export async function voidJournal(
  ...
  if (journal.isAutoGenerated)
    throw new BusinessRuleError(
      "Tidak dapat mem-void jurnal otomatis secara langsung",
      { journalId: id, isAutoGenerated: true },
    );
  ...
  if (!isOpen) {
    throw new BusinessRuleError(
      "Tidak dapat mem-void jurnal di periode fiskal yang sudah ditutup.",
      { journalId: id },
      "FISCAL_PERIOD_CLOSED",
    );
  }
