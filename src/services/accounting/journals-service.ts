...
export async function voidJournal(id: string, _userId?: string) {
    ...
    if (journal.isAutoGenerated) throw new Error("Cannot directly void an auto-generated journal entry. Please void the associated source document instead.");
...
export async function reverseJournal(id: string, userId?: string) {
    ...
    if (original.isAutoGenerated) throw new Error("Cannot directly reverse an auto-generated journal entry. Please reverse the associated source document instead.");
