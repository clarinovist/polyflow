...
export const BpjsRecapService = {
    async getRecap(
        ...
        const rows: BpjsRecapRow[] = employees.map((e) => {
            const empMaster =
                e.bpjsEmployeeDeduction != null
                    ? Number(e.bpjsEmployeeDeduction)
                    : 0;
            const empEmployer =
                e.bpjsEmployerCost != null ? Number(e.bpjsEmployerCost) : 0;
        ...
        return {
            ...
            totals: {
                ...
                sumEmployeeDeductionMaster: round2(
                    totals.sumEmployeeDeductionMaster,
                ),
