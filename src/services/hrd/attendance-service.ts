import { createAttendanceQueries } from './attendance-query-service';
import {
    PrismaClient,
    AttendanceSource,
    AttendanceStatus,
...
// Share the private projection type without a runtime import back from queries.
export type { RecordWithRelations };

const attendanceQueries = createAttendanceQueries({
    buildRecordResult,
    includeRelations,
});
...
export const AttendanceService = {
    ...
    listByDate: attendanceQueries.listByDate,

    getSummary: attendanceQueries.getSummary,
    ...
    listByRange: attendanceQueries.listByRange,

    getWeeklySummary: attendanceQueries.getWeeklySummary,

    listByEmployee: attendanceQueries.listByEmployee,

    getMonthlySummary: attendanceQueries.getMonthlySummary,
