...
export async function getSalesMetrics(
    ...
    const monthsInTrend =
        (trendEndDate.getFullYear() - trendStartDate.getFullYear()) * 12 +
    ...
    for (const order of orders) {
        ...
        if (order.customer) {
            ...
            if (
                ...
                order.orderDate > customerStats[customerId].lastOrderDate!
            ) {
    ...
    const averageOrderValue =
        kpiOrderCount > 0 ? totalRevenue / kpiOrderCount : 0;
