...
export function RevenueRulesClient() {
    ...
    async function handleAdd() {
        if (!newRule.matchValue || !newRule.accountCode) {
        ...
        <div className="space-y-4">
                ...
                <CardContent>
                    <div className="flex gap-3 items-end">
                        ...
                        >
                            ...
                            <SelectContent>
                                <SelectItem value="VARIANT_NAME_CONTAINS">
                        ...
                        <Input
                            placeholder="Match value (e.g. Super)"
                        ...
                        <Select
                            ...
                            onValueChange={(v) =>
                                setNewRule({ ...newRule, accountCode: v })
                            }
                        >
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Lower priority number = higher priority. First match
                        wins.
                    </CardDescription>
                </CardHeader>
                <CardContent>
