                  ...
                  <TableRow key={period.id}>
                    ...
                    <TableCell className="text-right">
                      <Button
                        ...
                        onClick={() =>
                          period.status === "OPEN"
                            ? handleCloseClick(period.id, period.name)
                            : handleStatusChange(period.id, period.status)
                        }
                        disabled={isPending}
                      >
                        {period.status === "OPEN" ? (
      ...
      <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
        <AlertDialogContent className="max-w-md">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Menutup periode ini akan otomatis membuat jurnal penutupan untuk
              mereset akun Revenue dan Expense. Tindakan ini penting untuk
