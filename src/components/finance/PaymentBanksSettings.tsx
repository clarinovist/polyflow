    ...
    return (
        <Card className="max-w-4xl">
            <CardHeader>
                ...
                <CardDescription>
                    Nomor rekening perusahaan untuk metode Transfer BCA,
                    Transfer Mandiri, dan alokasi clearing Cek/Giro. Data ini
                    khusus tenant aktif — tidak tercampur dengan tenant lain.
                </CardDescription>
            </CardHeader>
                            ...
                            <div className="space-y-3 rounded-lg border p-4">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        value={mandiriHolder}
                                        onChange={(e) =>
                                            setMandiriHolder(e.target.value)
                                        }
                                        placeholder="Nama pemilik rekening"
                                        disabled={!canEdit || saving}
                                    />
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setMandiriAccount(e.target.value)
                                        }
                                        placeholder="Nomor rekening"
                                        disabled={!canEdit || saving}
                                        inputMode="numeric"
