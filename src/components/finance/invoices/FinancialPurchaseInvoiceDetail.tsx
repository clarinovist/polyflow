...
export function FinancialPurchaseInvoiceDetail({
    invoice,
}: FinancialPurchaseInvoiceDetailProps) {
    ...
    return (
        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                {invoice.termOfPaymentDays != null && (
                                    <p className="text-xs text-muted-foreground mt-1">
                                        Tempo:{' '}
                                        {invoice.termOfPaymentDays === 0
                                            ? 'Cash'
                                            : `${invoice.termOfPaymentDays} hari`}
                                    </p>
                                )}
                            </div>
                            <div>
                    ...
                    {hasItems ? (
                        ...
                        <div className="rounded-md border p-4 bg-muted/20">
                            <p className="text-sm text-muted-foreground mb-4">
                                Operational details (quantity, delivery status)
            ...
            <div className="flex items-center gap-2 p-4 bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400 rounded-lg text-sm">
                ...
                <p>
                    This is a read-only financial view. To manage receipts or
                    edit items, switch to the Planning/Procurement module.
                </p>
            </div>
        </div>
    );
