...
import { updateSalesInvoiceDueDate } from '@/actions/finance/invoice';
...
export function EditSalesInvoiceDueDateDialog({
    open,
    onOpenChange,
    invoice,
}: Props) {
