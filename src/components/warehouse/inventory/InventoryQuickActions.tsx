            ...
            {lowStockCount !== undefined && lowStockCount > 0 && (
                <Link href="/warehouse/inventory?lowStock=true">
                    <Button
                        variant="outline"
                        size="sm"
                        className="text-xs gap-1.5 text-red-600 border-red-200 hover:bg-red-50 dark:hover:bg-red-950/30"
                    >
                        <span className="font-bold">{lowStockCount}</span> stok
                        menipis
                    </Button>
                </Link>
            )}
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    <DropdownMenuItem asChild>
                        <Link
                            href="/warehouse/inventory/adjustment"
