                ...
                <Card className="bg-primary/5 border-primary">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-primary">
                            {formatQuantity(summary.closingStock)}{' '}
                            ...
                            <TableBody>
                                ...
                                {entries.length === 0 ? (
                                    <TableRow>
                                        ...
                                        >
                                            Tidak ada mutasi ditemukan pada
                                            periode ini.
                                        </TableCell>
                                    </TableRow>
                                ) : (
                                    entries.map((e) => (
                                        ...
                                        >
                                            ...
                                            <TableCell className="text-right font-mono text-emerald-600">
                                                {e.qtyIn > 0
                                                    ? `+${formatQuantity(e.qtyIn)}`
                                                    : '-'}
                                            </TableCell>
                                            <TableCell className="text-right font-mono text-rose-600">
                                                {e.qtyOut > 0
                                                    ? `-${formatQuantity(e.qtyOut)}`
                                                    : '-'}
                                            </TableCell>
                                                ...
                                                <TooltipProvider>
                                                    <Tooltip>
                                                        ...
                                                        {e.reference && (
                                                            <TooltipContent
                                                                side="top"
                                                                className="max-w-[400px] whitespace-normal text-xs"
                                                            >
                                                                <p>
                                                                    {
                                                                        e.reference
