...
export function QualityControlWidget({ data }: Props) {
    ...
    const pieData = [
        ...
        {
            name: 'Karantina',
            value: data.inspections.quarantine,
        ...
        <div className="space-y-6">
                ...
                <Card className="bg-green-50 dark:bg-emerald-900/20 border-green-100 dark:border-emerald-800/50">
                    <CardContent className="p-6 flex flex-col items-center justify-center text-center">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="text-sm text-green-700 dark:text-emerald-400 font-medium uppercase tracking-wide">
                                Lulus
                            </p>
                        </div>
                        <p className="text-3xl font-bold text-green-800 dark:text-emerald-400">
                            {data.inspections.pass}
                        </p>
                        <p className="text-xs text-green-600 dark:text-emerald-400 mt-1">
                            {data.inspections.passRate}% Rate
                        </p>
                    </CardContent>
                </Card>
                <Card className="bg-red-50 dark:bg-red-900/20 border-red-100 dark:border-red-800/50">
                    <CardContent className="p-6 flex flex-col items-center justify-center text-center">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="text-sm text-red-700 dark:text-red-400 font-medium uppercase tracking-wide">
                                Gagal
                            </p>
                        </div>
                        <p className="text-3xl font-bold text-red-800 dark:text-red-400">
                            {data.inspections.fail}
                        </p>
                    </CardContent>
                </Card>
                <Card className="bg-amber-50 dark:bg-amber-900/20 border-amber-100 dark:border-amber-800/50">
                    <CardContent className="p-6 flex flex-col items-center justify-center text-center">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="text-sm text-amber-700 dark:text-amber-400 font-medium uppercase tracking-wide">
                                Quarantine
                            </p>
                        </div>
                        <p className="text-3xl font-bold text-amber-800 dark:text-amber-400">
                            {data.inspections.quarantine}
                        </p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>
                            {analyticsLabels.inspectionDistribution}
                        </CardTitle>
                        <CardDescription>
                            {analyticsLabels.inspectionDesc}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {pieData.length === 0 ? (
                            <div className="h-[300px] flex items-center justify-center text-muted-foreground">
                                {analyticsLabels.noInspectionData}
                            </div>
                        ) : (
                            <div
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            {analyticsLabels.topScrapReasons}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-4">
                            {data.scrapByReason.length === 0 ? (
                                <p className="text-muted-foreground text-center py-10">
                                    Tidak ada catatan scrap ditemukan.
                                </p>
                            ) : (
