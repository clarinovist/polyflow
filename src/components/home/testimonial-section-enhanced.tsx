...
const testimonials = [
    {
        ...
        content:
            'PolyFlow telah mengubah cara kami mengelola operasi manufaktur. Efisiensi produksi meningkat 35% dalam 3 bulan pertama.',
        avatar: 'BS',
    ...
    },
    {
        ...
        content:
            'Integrasi keuangan yang luar biasa. Kami bisa melihat profitabilitas real-time untuk setiap produk dan lini produksi.',
        avatar: 'SR',
    ...
    },
    {
        ...
        company: 'PT Indoplas',
        content:
            'Manajemen inventaris jauh lebih baik. Stok opname yang dulu butuh 2 hari, sekarang selesai dalam 2 jam.',
        avatar: 'AH',
    ...
    },
    {
        ...
        content:
            'CRM terintegrasi membantu kami meningkatkan repeat order sebesar 28%. Dashboard analitiknya sangat powerful.',
        avatar: 'DL',
        ...
        <section id="testimonials" className="py-28 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10">
                ...
                >
                    ...
                    >
                        Lihat bagaimana PolyFlow membantu bisnis konversi
                        plastik meningkatkan efisiensi dan profitabilitas.
                    </motion.p>
                </motion.div>
