...
export function MachineAllocationMatrix({
    ...
    const hasAnyAllocation = orders.some(
        (o) =>
            o.machineId &&
            timelineDays.some(
                (d) =>
                    toBusinessDateString(o.plannedStartDate) ===
                    toBusinessDateString(d),
            ),
    );
                ...
                <div className="mx-4 mt-4 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/30 flex items-start gap-3">
                    ...
                    <div>
                        <h4 className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">
                            Belum Ada Alokasi Jadwal
                        </h4>
                        <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
                            Tidak ada order produksi yang dijadwalkan pada mesin
                            untuk minggu ini. Klik tombol{' '}
                            <span className="font-semibold text-zinc-700 dark:text-zinc-300">
                                &quot;+ Alokasi&quot;
                            </span>{' '}
                            pada sel mesin/tanggal, atau pilih dari{' '}
                            <span className="font-semibold text-zinc-700 dark:text-zinc-300">
                                Antrian Dispatch
                            </span>{' '}
                            di bawah untuk mulai mengalokasikan.
                        </p>
                    </div>
                </div>
            )}
                    ...
                    <thead>
                        <tr>
                            ...
                            {timelineDays.map((day) => (
                                <th
                                    key={day.toISOString()}
                                    className="border-b border-r p-3 text-center min-w-[150px] bg-muted/30"
                                >
                        ...
                        {machines.map((machine) => (
                            ...
                            >
                                <td className="sticky left-0 z-10 bg-background group-hover:bg-muted/50 border-b border-r p-3">
                                    ...
                                    <div className="text-[10px] font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-tighter">
                                        {machine.type}
                                    </div>
                                    <Badge
                                        variant="outline"
                                ...
                                {timelineDays.map((day) => {
                                    ...
                                    return (
                                        <td
                                            ...
                                            className="border-b border-r p-2 align-top min-h-24 h-24 relative group/cell"
                                        >
                                            {dayOrders.length === 0 ? (
                                                <div
                                                ...
                                                >
                                                    ...
                                                    <span className="text-[10px] text-zinc-300 dark:text-zinc-600 group-hover/cell:text-zinc-500 font-medium">
                                                        Alokasi
                                                    </span>
                                                </div>
                                            ) : (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <div className="flex items-center justify-between text-[9px] mt-1 pt-1 border-t border-zinc-100 dark:border-zinc-800/80">
                                                                                        ...
                                                                                        <span className="uppercase font-semibold scale-90 origin-right shrink-0">
                                                                                            {
                                                                                                order.status
                                                                                            }
                                                                                        </span>
