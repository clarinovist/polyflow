                ...
                >
                    <div className="flex-none bg-background border-b px-6 pt-6">
                        <DialogHeader className="pb-3 pr-10">
                            ...
                            <DialogDescription>
                                Complete reference for work order workflows and
                                terminology
                            </DialogDescription>
                        </DialogHeader>
                            ...
                            <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-lg border">
                                ...
                                <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-700">
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-2 italic">
                                        * Can be cancelled from DRAFT, RELEASED,
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <div>
                                        ...
                                        <ul className="text-sm text-foreground/80 space-y-1 list-disc list-inside">
                                            <li>
                                                Material issues can only be
                                                recorded in IN_PROGRESS status
                                            </li>
                                            <li>
                                                Always verify material
                                                availability before releasing an
                                                order
                                            </li>
                                            <li>
                                                Record actual quantity
                                                accurately when completing
                                            </li>
                                            <li>
                                                Document all scrap and quality
                                                issues
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        >
                            ...
                            >
                                <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-lg border mb-4">
                                    ...
                                    <ol className="text-sm text-slate-700 dark:text-slate-300 space-y-1 list-decimal list-inside">
                                        ...
                                        <li>
                                            Inventory stock is automatically
                                            reduced
                                        </li>
                                        <li>
                                            Stock movement (OUT) is created for
                                            audit trail
                                        </li>
                                        <li>
                                            Linked to work order for tracking
                                        </li>
                                    </ol>
                                </div>
                                <div className="space-y-4">
                                ...
                                <div className="bg-amber-50 dark:bg-amber-900/20 p-3 rounded-lg border border-amber-200 dark:border-amber-800/50 mt-4">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className="text-sm text-amber-800 dark:text-amber-400">
                                            ...
                                            Record scrap immediately as it
                                            occurs, with specific reasons for
                                            analysis
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-lg border">
                                <h4 className="font-semibold mb-3">
                                    Example: Raffia Production Flow
                                </h4>
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-2 text-sm">
                                        ...
                                        <span className="text-slate-600 dark:text-slate-400">
                                            Mixed Granules → Raffia Roll (WIP)
                                        </span>
                                    </div>
                                    <div className="flex items-center gap-2 text-sm">
                                        ...
                                        <span className="text-slate-600 dark:text-slate-400">
                                            Raffia Roll → Raffia Bales
                                            (FINISHED_GOOD)
                                        </span>
                                    </div>
                                </div>
                                <p className="text-xs text-slate-600 dark:text-slate-400 italic mt-3">
                                    * Each stage requires its own work order and
                                    BOM
                                    <br />* Transfer material between locations
                                    as needed
                                </p>
                            </div>
                        </TabsContent>
                        ...
                        <TabsContent value="quality" className="space-y-6 mt-6">
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <div>
                                        ...
                                        <ul className="text-sm text-green-800 dark:text-green-300 space-y-1 list-disc list-inside">
                                            <li>
                                                Inspect at critical process
                                                points, not just at the end
                                            </li>
                                            <li>
                                                Document specific measurements
                                                and findings in notes
                                            </li>
                                            <li>
                                                Use QUARANTINE when uncertain
                                                rather than passing questionable
                                                product
                                            </li>
                                            <li>
                                                Follow up on all FAIL results
                                                with corrective actions
                                            </li>
                                            <li>
                                                Track patterns of repeat
                                                failures by product or machine
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-200 dark:border-blue-800/50">
                                <div className="text-sm text-blue-800 dark:text-blue-300">
                                    ...
                                    Multiple inspections can be recorded for a
                                    single work order. Include inspector name
        ...
        <div className="p-4 rounded-lg border bg-card relative overflow-hidden">
            <div
                className={cn(
                    ...
                    indicatorColors[color] || 'bg-zinc-200 dark:bg-zinc-700',
                )}
            />
            <div className="pl-2">
    ...
    return (
        <div className="p-4 rounded-lg border bg-card">
            <div className="flex items-start gap-3">
                <Icon
                    className={cn('h-6 w-6 flex-shrink-0 mt-0.5', textColor)}
                />
                <div className="flex-1">
                    <div className={cn('font-bold text-base mb-1', textColor)}>
                        {result}
                    </div>
                    <div className="text-sm mb-2 text-muted-foreground">
                        {description}
