        ...
        return (
            <>
                <Button
                    ...
                    title={productionComponentLabels.changeMachine}
                >
    ...
    return (
        <>
            <Button
                ...
                variant="outline"
                onClick={() => setOpen(true)}
                className="h-7 text-xs px-2 bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100 hover:text-blue-800 dark:bg-blue-900/20 dark:text-blue-400 dark:border-blue-900"
            >
                <Factory className="mr-2 h-3 w-3" />{' '}
                {productionComponentLabels.assignMachine}
            </Button>
            <ReassignMachineDialog
                open={open}
                onOpenChange={setOpen}
