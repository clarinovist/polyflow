                ...
                <form onSubmit={onSubmit}>
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 py-6">
                        ...
                        <div className="lg:col-span-5 space-y-6 flex flex-col">
                            <div className="bg-brand-glass backdrop-blur-2xl border border-brand-border p-5 rounded-xl shadow-brand space-y-5">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {matchedShift && (
                                            <p className="text-[10px] text-emerald-500 font-bold uppercase tracking-tight">Active: {matchedShift.name} ({matchedShift.startTime} - {matchedShift.endTime})</p>
                                        )}
                                    </div>
                            ...
                            <div className="flex-1 min-h-[300px] flex flex-col bg-brand-glass backdrop-blur-2xl border border-brand-border p-5 rounded-xl shadow-brand">
                                        ...
                                        <div
                                            ...
                                            className={cn(
                                                ...
                                                selectedHelpers.includes(helper.id)
                                                    ...
                                                    : "bg-black/5 dark:bg-white/5 border-transparent hover:bg-brand-glass-heavy hover:border-brand-border"
                                            )}
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            ...
                            <div className="bg-brand-glass backdrop-blur-2xl border border-brand-border p-5 rounded-xl shadow-brand space-y-5">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    />
                                    <Button type="button" size="lg" onClick={handleAddRoll} disabled={!currentRollWeight} className="h-11 px-8 font-bold italic uppercase tracking-tight shadow-lg">Add</Button>
                                </div>

                                <div className="h-[250px] overflow-y-auto border border-brand-border/50 rounded-xl bg-black/10 dark:bg-black/20 p-4 custom-scrollbar">
                                    {rolls.length === 0 && (
                            ...
                            <div className="bg-brand-glass backdrop-blur-2xl border border-brand-border p-5 rounded-xl shadow-brand space-y-3">
