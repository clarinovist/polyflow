        ...
        return (
            <Card className="shadow-sm bg-card/65 backdrop-blur-sm border">
                <CardHeader className="pb-3">
                    ...
                    <CardDescription>
                        Stack visual per proses. Bandingkan share, bukan total
                        ekonomi. Timestamp = waktu log kiosk.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            ...
                            >
                                ...
                                <Bar
                                    ...
                                    name="Mixing"
                                    stackId="a"
                                    fill={PROCESS_COLORS.MIXING}
                                />
                                <Bar
                                    dataKey="EXTRUSION"
                                    name="Extrusion"
                                    stackId="a"
                                    fill={PROCESS_COLORS.EXTRUSION}
                                />
                                <Bar
                                    dataKey="PACKING"
                                    name="Packing"
                                    stackId="a"
                                    fill={PROCESS_COLORS.PACKING}
                                />
                                <Bar
                                    dataKey="OTHER"
                                    name="Lainnya"
    ...
    return (
        <Card className="shadow-sm bg-card/65 backdrop-blur-sm border">
            <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between pb-3 gap-2">
                <div>
                    <CardTitle className="text-lg font-bold tracking-tight">
                        {tab === 'OTHER' ? 'Lainnya' : tab} — output dicatat per
                        jam
                    </CardTitle>
                    <CardDescription>
                        Hari ini vs rerata 7 hari (proses yang sama). Bukan
                        run-rate mesin.
                    </CardDescription>
                </div>
            ...
            <CardContent>
                ...
                <p className="text-[10px] text-muted-foreground mt-2 border border-dashed rounded-md px-2 py-1.5">
                    Multi-log kiosk (8–9×/shift) bikin spike jam catat — normal.
                    Bandingkan hanya dalam proses yang sama.
                </p>
            </CardContent>
        </Card>
    );
