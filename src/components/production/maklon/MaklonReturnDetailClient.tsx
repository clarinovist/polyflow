    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Badge
                            className={getStatusColor(ret.status)}
                            variant="secondary"
                        >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="font-medium">
                                    {format(new Date(ret.returnDate), 'PPP')}
                                </p>
                            </div>
                            <div>
                                <p className="text-sm text-muted-foreground">
                            ...
                            <div>
                                ...
                                <p className="font-medium">
                                    {getMaklonReturnLocationLabel(
                                        ret.sourceLocation,
                                    )}
                                </p>
                                {ret.sourceLocation?.slug ===
                                    MAKLON_STAGE_SLUGS.PACKING && (
                                    <p className="text-xs text-muted-foreground">
                                        Linked to Maklon Packing Area
                                    </p>
                                )}
                            </div>
                            <div>
            ...
            <EntityStatusTimeline
                entityType="MaklonMaterialReturn"
                entityId={ret.id}
            />
        </div>
    );
