...
export function MaklonReturnTable({
    initialData,
    basePath = '/maklon/returns',
}: MaklonReturnTableProps) {
                            ...
                            >
                                <CardHeader className="p-4 pb-2">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <Badge
                                            variant="secondary"
                                            className={`text-[10px] px-1.5 h-5 ${getStatusColor(ret.status)}`}
                                        >
