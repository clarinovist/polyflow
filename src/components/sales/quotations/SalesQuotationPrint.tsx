...
export function SalesQuotationPrint({
    ...
    return (
        <div
            className="p-8 text-black bg-white font-sans max-w-4xl mx-auto print:p-0 print:max-w-none"
      ...
      `}</style>
            ...
            <div className="flex items-start gap-4 border-b-2 border-black pb-4 mb-6 print-avoid-break">
                <div className="flex items-center gap-3 flex-1">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-600 whitespace-pre-line leading-relaxed mt-1">
                            {COMPANY.address}
                        </p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6 print-avoid-break">
                <div>
                    <table className="w-full text-xs border-none self-start">
                        <tbody>
                            <tr>
                                <td className="w-16 font-semibold py-1">
                                    Nomor
                                </td>
                            ...
                            <tr>
                                ...
                                <td className="py-1">
                                    {quotation.subject ||
                                        'Penawaran Harga Produk Plastik'}
                                </td>
                            </tr>
                            <tr>
                ...
                <div className="pl-4 border-l border-gray-200">
                    ...
                    <p className="font-bold text-gray-800">
                        {customer?.name || 'Prospect Customer'}
                    </p>
            ...
            <div className="mb-6 text-justify">
                ...
                <p>
                    Sehubungan dengan adanya permintaan penawaran harga produk
                    dari pihak Bapak/Ibu, bersama surat ini kami mengajukan
                    penawaran harga terbaik untuk produk-produk berkualitas kami
            ...
            <table className="w-full text-xs border-collapse mb-6 print-table">
                <thead>
                    <tr className="border-y-2 border-black bg-gray-50 font-semibold">
                        ...
                        <th className="py-2 text-right px-2 w-[120px]">
                            Kuantitas
                        </th>
                        <th className="py-2 text-right px-2 w-[140px]">
                            Harga Satuan
                        </th>
                        <th className="py-2 text-right px-2 w-[80px]">
                            Diskon
                        </th>
                        <th className="py-2 text-right px-2 w-[80px]">Pajak</th>
                        <th className="py-2 text-right px-2 w-[150px]">
                            Total Penawaran
                        </th>
                    </tr>
                </thead>
                <tbody>
                    {items.map((item, index) => {
                        const qtyDisp = getEnteredQuantityDisplay({
                            ...item,
                            ...item.productVariant,
                        });
                        const priceDisp = getEnteredUnitPriceDisplay({
                            ...item,
                            ...item.productVariant,
                        });
                        return (
                            <tr
                                key={item.id || index}
                                className="border-b border-gray-200 hover:bg-gray-50/10"
                            >
                ...
                <div className="text-xs space-y-2">
                    ...
                    <div className="border rounded-md p-3 bg-gray-50/50 space-y-1.5 leading-relaxed text-gray-600">
                        ...
                        {quotation.validUntil && (
                            <p>
                                • <strong>Masa Berlaku Penawaran:</strong> S/D{' '}
                                {format(
                        ...
                        {quotation.termsConditions ? (
                            ...
                            <p className="text-[10px] text-gray-400">
                                Harga franco pabrik dan dapat dinegosiasikan
                                sebelum pemesanan.
                            </p>
                        )}
                    </div>
                ...
                <div className="font-mono text-xs space-y-1.5 border-t pt-2 border-gray-300">
                    ...
                    {Number(quotation.discountAmount) > 0 && (
                        <div className="flex justify-between text-red-600">
                            ...
                            <span>
                                -
                                {formatRupiah(Number(quotation.discountAmount))}
                            </span>
                        </div>
                    )}
                    {Number(quotation.taxAmount) > 0 && (
                        <div className="flex justify-between">
                            ...
                            <span>
                                {formatRupiah(Number(quotation.taxAmount))}
                            </span>
                        </div>
                    )}
            ...
            <div className="mb-8 text-justify print-avoid-break">
                <p>
                    Demikian surat penawaran harga ini kami sampaikan. Besar
                    harapan kami untuk dapat menerima kabar baik serta menjalin
                    kerja sama kemitraan yang saling menguntungkan dengan pihak
                    Bapak/Ibu di masa mendatang. Atas perhatian dan
