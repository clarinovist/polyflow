            ...
            <Card className="bg-background/40 backdrop-blur-xl border-white/10 dark:border-white/5 shadow-xl border-0">
                ...
                <CardContent className="space-y-3">
                    ...
                    <Row
                        ...
                        value={
                            emp.maritalStatus
                                ? MARITAL_LABELS[emp.maritalStatus] ||
                                  emp.maritalStatus
                                : '-'
                        }
                    />
            ...
            <Card className="bg-background/40 backdrop-blur-xl border-white/10 dark:border-white/5 shadow-xl border-0">
                ...
                <CardContent className="space-y-3">
                    ...
                    <Row
                        ...
                        value={emp.bpjsKesehatanNo || '-'}
                    />
                    <Row
                        label="No. BPJS Ketenagakerjaan"
                        value={emp.bpjsKetenagakerjaanNo || '-'}
                    />
                    <Row
                        label="Iuran BPJS Karyawan"
                        value={
                            emp.bpjsParticipant
                                ? fmtIdr(toN(emp.bpjsEmployeeDeduction))
                                : '-'
                        }
                    />
                    <Row
                        label="Iuran BPJS Perusahaan"
                        value={
                            emp.bpjsParticipant
                                ? fmtIdr(toN(emp.bpjsEmployerCost))
                                : '-'
                        }
                    />
                    {emp.payType === 'MONTHLY' && (
                        <Row
                            label="Gaji Bulanan"
                            value={fmtIdr(toN(emp.monthlySalary))}
                        />
                    )}
                </CardContent>
            </Card>
