                                    ...
                                    {loans.map((k) => (
                                        <TableRow key={k.id}>
                                            ...
                                            <TableCell className="text-right text-sm font-mono">
                                                {fmtIdr(toN(k.principalAmount))}
                                            </TableCell>
                                            <TableCell className="text-right text-sm font-mono">
                                                {fmtIdr(
                                                    toN(k.remainingBalance),
                                                )}
                                            </TableCell>
                                            <TableCell className="text-right text-sm font-mono">
                                                {k.installmentAmount
                                            ...
                                            <TableCell>
                                                <span
                                                    className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${STATUS_BADGE[k.status] || ''}`}
                                                >
                                                    {k.status}
                                                </span>
                                            </TableCell>
