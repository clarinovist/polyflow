    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3 items-center bg-card p-4 rounded-xl border">
                ...
                <Select
                    value={payType || '__all__'}
                    onValueChange={(v) => setPayType(v === '__all__' ? '' : v)}
                >
                ...
                <Select
                    value={employment || '__all__'}
                    onValueChange={(v) =>
                        setEmployment(v === '__all__' ? '' : v)
                    }
                >
            ...
            <div className="bg-card rounded-xl border overflow-x-auto">
                <Table>
                    <TableHeader className="bg-muted/50">
                        <TableRow>
                            <TableHead className="font-semibold text-muted-foreground w-[60px]">
                                Kode
                            </TableHead>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <Badge
                                                variant="outline"
                                                className={`text-[10px] font-bold py-0 h-5 ${PAY_TYPE_COLORS[emp.payType] || ''}`}
                                            >
                                                {payTypeLabels[emp.payType] ||
                                                    emp.payType}
                                            </Badge>
                                        </TableCell>
                                        <TableCell>
