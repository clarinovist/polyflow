...
import { ChevronLeft, Phone, MapPin, Building2, CreditCard, Mail, DollarSign, Percent, History } from 'lucide-react';
...
export function CustomerDetailClient({ customer, salesOrders }: CustomerDetailClientProps) {
    return (
