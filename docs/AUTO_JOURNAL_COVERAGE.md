...
|                   | Internal Stock Movement     | `planned`           | _None_                                      | Saat ini tidak menghasilkan efek jurnal keuangan (hanya perpindahan lokasi fisik) |

---

## Ketentuan Arsitektur & Source of Truth

1. **Jalur Tunggal (_Single Source of Truth_)**:
