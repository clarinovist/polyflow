...
INSERT INTO "Account" (id, code, name, type, category, "createdAt", "updatedAt")
SELECT gen_random_uuid()::text, '1-129', 'Persediaan Barang Setengah Jadi', 'ASSET', 'CURRENT_ASSET', NOW(), NOW()
...
INSERT INTO "Account" (id, code, name, type, category, "createdAt", "updatedAt")
SELECT gen_random_uuid()::text, '11325', 'Semi-Finished Goods', 'ASSET', 'CURRENT_ASSET', NOW(), NOW()
